...
def get_document(request, document_id):
    ...
    """
    doc = document_service.get_document(document_id, user=request.user if request.user.is_authenticated else None)
...
def chat_with_document(request, document_id):
    ...
    _, remaining = chat_service.check_question_limit(doc, user=request.user if request.user.is_authenticated else None)
